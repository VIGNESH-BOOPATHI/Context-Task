...
function Navbar() {
  const { cartItems, removeFromCart, increaseItemQuantity, decreaseItemQuantity } = useCart();
  ...
  <div key={item.id} className="cart-item">
    <div>{item.title}</div>
    <div>
      <button onClick={() => increaseItemQuantity(item.id)} className="btn btn-outline-danger">+</button>
      <span>{item.quantity}</span>
      <button onClick={() => decreaseItemQuantity(item.id)} className="btn btn-outline-danger">-</button>
    </div>
